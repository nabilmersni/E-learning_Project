                ...
                <div class="dash__instructor-home">
                    ...
                    <div class="dash__instructor-home__content">
                        <div class="dash__instructor-home__content__left-side">
                            ...
                            <div class="dash__instructor-home__content__left-side__latest-courses">
                                <div class="dash__instructor-home__content__left-side__latest-courses__head">
                                    <h1 class="dash__instructor-home__content__left-side__latest-courses__head__title">
                                        Latest added courses
                                    </h1>

                                    <a href="./dash_instructor-courses.php"
                                        class="secondary-btn secondary-btn__latest-course">
                                        See All Courses
                                        <div
                                            class="secondary-btn__svg-container secondary-btn__latest-course__svg-container">
                                            ...
                                            <svg class="secondary-btn__svg secondary-btn__latest-course__svg"
                                                ...
                                                <g id="see-icon" transform="translate(-0.002 -5.5)">
                                                    <path id="Path_1047" data-name="Path 1047"
                                                        ...
                                                        fill="currentColor" />
                                                    <circle id="Ellipse_34" data-name="Ellipse 34" cx="4.2" cy="4.2"
                                                        r="4.2" transform="translate(11.8 11.8)" fill="currentColor" />
                                                </g>
                                            </svg>
