                ...
                <div class="dash__instructor-my-courses">
                    ...
                    <div class="button_group">
                        <div >
                            ...
                            <button class="button_b1 " id="button_b1_req"><i class="fas fa-pen-nib" style="padding-right:0.5rem"></i>Basics</button>
                        </div>    
                    ...
                    <div class="public_information" id="requirement_id" >
                        ...
                        <div class="course__add">
                            ...
                            <!--show update requirement-->
                            <div id="show_update_req" >
                                ...
                                <div class="add_new_req_v1">
                                    <div class="add_lesson_header">
                                        <div class="add_new_lesson_v1_title">Update requirement</div>
                                    ...
                                    <div class="dash__content" style="position: relative;bottom: 100px;">
                                        ...
                                        <form action="formation_code/update_requirement_code.php?id=<?php echo $_GET['id']; ?>&id_req=<?php echo $req_id; ?>"  method="POST">
                                            <div class="dash__instructor-my-courses">
                                                ...
                                                <div>
                                                <?php 
                                                $listeReq = $requirementC->recuperer_requirement($_GET['req_id']);
                                                    foreach($listeReq as $req){
                                                ?>
                                                    <input class="add_new_lesson-v1__input-border" name="req_content"
                                                        value="<?php echo $req['req_content']; ?>" >
                                                    <?php
                                                    }
                                                    ?> 
