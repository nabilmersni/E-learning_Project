...
<head>
    ...
    #chapter_title-error,#chapter_description-error{
            ...
            <div class="dash__content">
                <div class="dash__instructor-my-courses">
                        ...
                        <div class="course__add">
                            ...
                            <div class="course__add-v1">
                                <h1 class="course__add-v1__info">
                                    Chaptre N°<?php echo $i; ?>
                                </h1>
                                <button id="popup_id2" class="popup" onmouseenter="myFunction2()"
                                    onmouseleave="myFunction2()"
                                    style="background-color: transparent; border-color: transparent;">
                                    <svg id="more_info_button" viewBox="0 0 24 24" fill="grey"
                                        ...
                                        <path fill="white"
                                            ...
                                            style="animation:n-info-ques .8s cubic-bezier(.455,.03,.515,.955) both infinite" />
                                    </svg>
                            ...
                            <div style="padding-bottom: 3.5rem;">
                                <div class="chapter">
                                    ...
                                    <div style="padding-right: 1.9rem;">
                                        ...
                                        <span id="modifier_chapter_btn" >
                                            <svg  class="delete-button" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <!--bouton up-->
                                        <span id="up_button" class="up_button_test">
                                            <svg class="up-button" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        ...
                                        <!--bouton down-->
                                        <span id="down_button" class="down_button_test" hidden>
                                            <svg class="up-button" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div id="lesson_lines" class="chapter-lesson" class="lesson_lines_test">
                                <?php
                                ...
                                <!--quiz lesson-->
                                    ...
                                    <div class="chapter-lesson-l1-icon-aligne">
                                        <div class="chapter-lesson-l1">
                                            <svg class="chapter-lesson-l1-icon" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
                                        ...
                                        <i class="fas fa-edit " id="edit_quiz"></i>
                                            <svg id="update_lesson_button_p1" class="chapter-lesson-l1-icon"
                                            ...
                                            <svg id="update_lesson_button" class="chapter-lesson-l1-icons"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path fill-rule="evenodd"
                                                    d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z"
                                    ...
                                    <div class="chapter-lesson-l1-icon-aligne">
                                        ...
                                        <a style="text-decoration:none; color:currentColor" href="">
                                            <svg id="update_lesson_button" class="chapter-lesson-l1-icon"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path
                                                    d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z">
                                ...
                                <div class="chapter-add-lesson">
                                    <svg id="lesson_hover" class="lesson_icon"
                                        style="width: 2.5rem; margin-right:1rem;    " xmlns="http://www.w3.org/2000/svg"
                            ...
                            <!--show update chapter-->
                            <div id="show_update_chapter" hidden>
                            <div class="add_new_lesson">
                                ...
                                <div class="add_new_lesson_v1">
                                    <div class="add_lesson_header">
                                        ...
                                        <div id="x_update_chapter" class="x_botton_lesson">
                                            <svg id="x_button_x_lesson" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="#4a5bcf">
                                                <path fill-rule="evenodd"
                                    ...
                                    <div class="dash__content" style="position: relative;bottom: 100px;">
                                        ...
                                        <form id="update_chapter_id" action="formation_code/update_chapter.php?id=<?php echo $chapter['chapter_id']; ?>&id_f=<?php echo $_GET['id']; ?>" method="POST">
                                            <div class="dash__instructor-my-courses">
                                                ...
                                                <div>
                                                    <input class="add_new_lesson-v1__input-border" name="chapter_title"
                                                        value="<?php echo $row['chapter_title']; ?>">
                                                </div>
                                                ...
                                                <div>
                                                    <textarea name="chapter_description" id="" class="add_new_lesson-v1__texterea-border"
                                                ><?php echo $row['chapter_description']; ?></textarea>
                                                </div>
                                                ...
                                                <input name="update_chapter_button" class="save-btn save-btn-topbar" type="submit" value="Update" style="position:relative;bottom:20px;">
                    ...
                    <?php
                        ...
                        <div class="course__add">
                            <a id="create_chapter" href="#"
                                style="margin-top: 5rem; margin-left: 1.7rem;margin-bottom: 0rem; max-width: 23.4rem; ;"
                                class="img_secondary-btn img_secondary-btn-topbar">
                                <div>

                                    <svg style="position: relative; right: 20px;" class="w-4"
                            ...
                            <div id="show_create_chapter" class="show_create_chapter" hidden>
                                ...
                                <form method="POST" id="add_chapter_id" action="formation_code/add_chapter.php?id=<?php echo $_GET['id']; ?>" >
                                    <div class="course__add-v1__title">
                                        <h4 style="font-size: 3rem; color: #4a5bcf">Create a chapter</h4>
                                    </div>

                                    <div style="margin-top: 1.7rem ;">
                                        <input style="padding-left: 2rem; font-family: inherit; font-size: 2rem;"
                                            class="chapter_description_input" name="chapter_title" placeholder="chapter title">
                                    </div>
                                    ...
                                    <div style="padding-top: 3.5rem;">
                                        <textarea style="padding-left: 2rem; font-family: inherit; font-size: 2rem;"
                                            name="chapter_description" id="" class="chapter_description-texterea-border"
                                    ...
                                    <input type="submit" 
                                        style="margin-top: 5rem; margin-left: 0rem;margin-bottom: 0rem; font-size: 2rem; font-weight: 400;border:none;cursor:pointer"
                                        class="img_secondary-btn img_secondary-btn-topbar" value="create a chapter">
                                        
                            </input>
                                </form>

                                <div id="x_button" class="x_botton">
                                    <svg id="x_button_x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                        fill="#4a5bcf">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                                            clip-rule="evenodd"></path>
                ...
                <div class="dash__content" style="position: relative;bottom: 100px;">
                    ...
                    <form action="#" method="POST">
                        <div class="dash__instructor-my-courses">
                            ...
                            <div>
                                <input class="add_new_lesson-v1__input-border" name="lesson_title"
                            ...
                            <div>
                                <textarea name="lesson_description" id="" class="add_new_lesson-v1__texterea-border"
                                    placeholder="Description for my lesson"></textarea>
                            </div>
                                ...
                                <div class="add_new_lesson-v1__input_video">
                                    <div class="add_new_lesson-v1__input_video_border">
                                        ...
                                        <div class="add_new_lesson-v1__input_video_device_icon">
                                            <svg id="my_device_icon" aria-hidden="true" focusable="false" width="26"
                                                height="26" viewBox="0 0 32 32">
                                                <g fill="none" fillRule="evenodd">
                                                    <rect id="my_device_icon_color" class="uppy-ProviderIconBg"
                                                        width="32" height="32" rx="16" fill="#2275D7">
                                                    </rect>
                                                    <path
                                        ...
                                        <div class="add_quiz_content_l1-v1">
                                            ...
                                            <span>
                                                <a href="./formation_code/delete_question.php?id=<?php echo $question['question_id']; ?>">
                                                    <svg class="quiz_delete_button" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 20 20" fill="currentColor">
                                                        <path fill-rule="evenodd"
                                            ...
                                            <span id="quiz_up_button">
                                                <svg class="quiz_up-button" xmlns="http://www.w3.org/2000/svg"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
