                            ...
                            <div id="show_create_chapter" hidden>
                                ...
                                <div class="show_create_chapter">
                                    ...
                                    <form method="POST" id="add_chapter_id" action="formation_code/add_chapter.php?id=<?php echo $_GET['id']; ?>">
                                        ...
                                        <div class="form__input__group">
                                            <label for="chapter_duration" class="form__input__label">Chapter duration<span>*</span></label>
                                            <input id="chapter_duration" name="chapter_duration" type="number" class="form__input" style="padding-left:1.5rem" placeholder="Chapter duration">
                                        </div>
