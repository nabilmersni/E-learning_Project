...
<!--*********************************************Add new course******************************************************-->                     
                            <form method="POST" action="./formation_code/add_formation.php" id="add_formation" enctype="multipart/form-data">
                            ...
                            <div class="course__add-v1__image">
                                ...
                                <img src="" class="course__add-v1__image_insert" alt="" id="course_file_img"  accept="image/*" >
                                ...
                                <div>
                                    <p style="padding-bottom: 40px;" class="course__add-v1__image_description">
                                        ...
                                        <input name="course_image" type="file" id="course_file_upload"  value="Choose a photo" class="img_secondary-btn img_secondary-btn-topbar">
                                        <div>
