...
$lessonC = new LessonC();
$listeLessons = $lessonC->afficher_lessons_page_order($_GET['id_chapter']);
        ...
        <div class="dash__container">
            ...
            <div class="dash__content">
                <div class="dash__instructor-my-courses">
                    <div class="dash__instructor-my-courses__title"><a href="dash_instructor-chapter-add.php?id=<?php echo $_GET['id']; ?>" class="dash__instructor-my-courses__title sort_back_btn">Back</a>
                    </div>
                    ...
                    <div class="public_information">
                        ...
                        <div class="course__add" style="padding: 1.5rem 0rem;">
                            <!-------------------------------------------------------------------------->
                            ...
                            <ul class="list-unstyled" id="page_list">
                                ...
                                foreach ($listeLessons as $lesson) {
                                    $i = $lesson['page_order'] + 1;
                                ?>


                                    <li id="<?php echo $lesson['lesson_id']; ?>"><span style="font-weight: bold;">Lesson<?php echo $i; ?>: &nbsp</span>
                                        <?php if (strcmp($lesson['lesson_type'], "quiz") == 0) { ?>
                                            <svg class="chapter-lesson-l1-icon svg_sort_lesson" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        $(document).ready(function() {
            $("#page_list").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        url: "formation_code/update_sort_lessons.php",
                        method: "POST",
                        data: {
