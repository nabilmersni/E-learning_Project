...
$listeReponses = $reponseC->afficher_reponses_page_order($_GET['id']);
    ...
    <div class="dash">
        ...
        <div class="dash__container">
            ...
            <div class="dash__content">
                ...
                <div class="dash__instructor-my-courses__title" ><a href="dash_instructor-quiz-add.php?id_f=<?php echo $_GET['id_f']; ?>&id_l=<?php echo $_GET['id_l']; ?>" class="dash__instructor-my-courses__title sort_back_btn">Back</a>
                </div>
                        ...
                        <div class="course__add" style="padding: 1.5rem 0rem;">
                            ...
                            <?php
                                ...
                                foreach ($listeReponses as $reponse) {
                                    $i = $reponse['page_order'] + 1;
                                ?>
                                

                                    <li id="<?php echo $reponse['reponse_id']; ?>"><span style="font-weight: bold;">Option <?php echo $i; ?>: &nbsp</span><?php echo $reponse['reponse_content']; ?> </li>
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"formation_code/update_sort_options.php",
    method:"POST",
