                ...
                <div class="dash__instructor-my-courses">
                    ...
                    <div class="button_group">
                        <div>
                            ...
                            <a class="button_b1 " href="#"><i class="fas fa-pen-nib"
                                    style="padding-right:0.5rem"></i>Basics</a>
                        </div>
                    ...
                    <div class="public_information">
                        ...
                        <div class="course__add">
                            ...
                            <div class="course__add-v1">
                                ...
                                <button id="popup_id" class="popup" onmouseenter="myFunction()"
                            ...
                            <form method="POST"
                                action="./formation_code/update_formation.php?id=<?php echo $_GET['id']; ?>"
                                id="add_formation" enctype="multipart/form-data">
                                <div class="course__add-v1__title">
                                    <h4>Course Title</h4>
                                </div>

                                <div>
                                    <input value="<?php echo $formation['name']; ?>" class="title-input-border"
                                        name="course_title">
                                </div>
                                ...
                                <div>
                                    <textarea id="short_description" class="description-texterea-border"
                                        name="short_description"><?php echo $formation['short_description']; ?></textarea>
                                </div>
                                ...
                                <div class="course__add-table-prix">
                                    ...
                                    <div class="course__add-table-prix">
                                        ...
                                        <input value="<?php echo $formation['price']; ?>" name="course_price"
                                            class="input-table-prix-currence" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="course__add-v1__image">
                                    ...
                                    <div class="course__add-v1__image_insert">
                                        <img src="formation_code/uploads/<?php echo $formation['image']; ?>" alt=""
                                            class="course__add-v1__image_insert" id="course_file_img" accept="image/*">
                                        ...
                                        <svg class="w-8" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <div>
                                        ...
                                        <label for="course_file_upload" class="course_file_upload_image">Choose a
                                            photo</label>
                                        <input name="course_image" type="file" id="course_file_upload"
                                            value="Choose a photo" class="img_secondary-btn img_secondary-btn-topbar"
                                            style="display:none">
                                        <div>
