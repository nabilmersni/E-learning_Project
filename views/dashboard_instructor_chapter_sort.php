                        ...
                        <div class="course__add" style="padding: 1.5rem 0rem;">
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    <li id="<?php echo $chapter['chapter_id']; ?>"><span style="font-weight: bold;">Chaptre <?php echo $i; ?>: &nbsp</span><?php echo $chapter['chapter_title']; ?> </li>
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"formation_code/update_sort_chapters.php",
    method:"POST",
