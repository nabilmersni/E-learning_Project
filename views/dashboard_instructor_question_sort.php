                        ...
                        <div class="course__add" style="padding: 1.5rem 0rem;">
                            ...
                            <?php
                                ...
                                foreach ($listeQuestions as $question) {
                                    $i = $question['page_order'] + 1;
                                ?>
                                

                                    <li id="<?php echo $question['question_id']; ?>"><span style="font-weight: bold;">Question <?php echo $i; ?>: &nbsp</span><?php echo $question['question_content']; ?> </li>
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"formation_code/update_sort_questions.php",
    method:"POST",
