            ...
            <div class="dash__content">
                <div class="dash__instructor-home">
                    ...
                    <div class="offer_container">
                        ...
                        <div class="offerList">
                            <h2 class="offerList__title">
                                Offer List
                            </h2>

                            <div class="offerList__container">
                                <?php 
                                    while($offer = $data->fetchObject()) {
                                ?>
                                <div class="offerList__item">
                                    <div class="offerList__item__img-container">
                                        <img src="../contents/img/course-cover.jpg" alt="" class="offerList__item__img">
                                    </div>
                                    <div class="offerList__item__content">
                                        <div class="offerList__item__content__txt">
                                            <h2 style="min-width:38rem;" class="offerList__item__content__title">
                                                <?php echo $offer->name ?>
                                            </h2>
                                            <p class="offerList__item__content__reduction">
                                                <?php echo $offer->reduction ?>%
                                            </p>
                                        </div>
                                        <table class="user-table user-table-offer">
                                            <td class="btn-td btn-td-offer">
                                                <form style="display:inline-block;"
                                                    action="../controllers/offerController.php?event=deleteOffer"
                                                    method="POST">
                                                    <input type="hidden" value="<?php echo $offer->offer_id ?>"
                                                        name="offer_id">

                                                    <input type="hidden" value="<?php echo $offer->formation_id ?>"
                                                        name="formation_id">
